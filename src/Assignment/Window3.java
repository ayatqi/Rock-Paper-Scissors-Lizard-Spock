...
public class Window3 extends JFrame implements ActionListener
{
    ...
    public Window3()
    {
        ...
        lb3 = new JLabel("<html><span style='font-size:12px;'>" + Window2.c);
    ...
    public static String t1value1;
    public static String t1value2;
    public static String t1value3;
    public static String t1value4;
    public static String t1value5;
    public static String t1value6;
    public static String t1value7;
    public static String t1value8;
    int player1;
    int player2;
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        { 
            ...
            if(((tl3.getText()=="0") && (tl7.getText()=="1")) || ((tl3.getText()=="1") && (tl7.getText()=="0")) || ((tl3.getText()=="0") && (tl7.getText()=="0"))) //if score is detected in round three, it adds all rounds together
                ...
                t1value1 = tl1.getText(); // round 1 1st value
                t1value5 = tl5.getText(); // round 1 2nd value
                
                t1value2 = tl2.getText(); // round 2 1st value
                t1value6 = tl6.getText(); // round 2 2nd value
                
                t1value3 = tl3.getText(); // round 3 1st value
                t1value7 = tl7.getText(); // round 3 2nd value
                
                t1value4 = tl4.getText(); // total 1st value
                t1value8 = tl8.getText(); // total 2nd value
